...
public String buildPromptForReturningAssignments(Long organizationId, Long employeeId, String assetsBlock) {
...
Your task is to generate a formal "ПРОТОКОЛ ЗА ВРЪЩАНЕ НА АКТИВИ" in Bulgarian.
...
- Render ALL assets under section "II. Предмет на връщане".
...
1. Активите се връщат на Организацията след прекратяване на трудовото правоотношение или по поискване.
2. Върнатите активи се приемат в добро състояние, с допустимо нормално износване.
3. Всяка щета или липса се регистрира и се обезщетява съгласно вътрешните политики на Организацията.
4. Получателят потвърждава, че активите са върнати напълно и в договореното състояние.
...
Your task is to generate a formal "ПРОТОКОЛ ЗА ПРИЕМАНЕ НА АКТИВИ" in Bulgarian.
