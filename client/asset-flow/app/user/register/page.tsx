          ...
          <div className="relative flex h-full flex-col justify-between gap-10">
            ...
            <div className="grid gap-3">
              <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur">
                <p className="text-sm text-slate-100">{t("registerPage.bulletOne")}</p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur">
                <p className="text-sm text-slate-100">{t("registerPage.bulletTwo")}</p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur">
                <p className="text-sm text-slate-100">{t("registerPage.bulletThree")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="surface-panel rounded-[2rem] border border-white/70 p-6 sm:p-8 lg:p-10">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold text-slate-950">{t("registerPage.formTitle")}</h2>
              <p className="mt-2 max-w-xl text-sm text-slate-600">{t("registerPage.formSubtitle")}</p>
            </div>
          </div>
